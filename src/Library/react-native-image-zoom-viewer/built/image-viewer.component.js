...
var ImageViewer = /** @class */ (function (_super) {
        ...
        */
        ...
        _this.handleClick = function () {
            if (_this.props.onClick) {
                ...
                _this.setState({ showControl: !_this.state.showControl });
            }
        };
        /**
         * 双击
    ...
    ImageViewer.prototype.getContent = function () {
        ...
        <react_native_1.Animated.View style={__assign({}, this.styles.container, { opacity: this.fadeAnim })}>
          ...
          {this.state.showControl && this.props.renderHeader(this.state.currentShowIndex)}
          {this.state.showControl && this.props.renderIndicator((this.state.currentShowIndex || 0) + 1, this.props.imageUrls.length)}
          ...
          <react_native_1.View style={[{ bottom: 0, position: 'absolute', zIndex: 9 }, this.props.footerContainerStyle]}>
            ...
            {this.state.showControl && this.props.renderFooter(this.state.currentShowIndex)}
          </react_native_1.View>
        </react_native_1.Animated.View>
      </react_native_1.Animated.View>);
    };
