...
export default class Search extends Component {
  ...
  render = () => {
    ...
    // console.log(" 0000000 > " + getHeaderHeight() + ", heightAdjust : " + heightAdjust)
    const {
      placeholder,
      heightAdjust,
      backgroundColor,
    ...
    // return(<View style={[styles.container, {backgroundColor:'green'}]}><Text>test</Text></View>)
    return (
      // <Animated.View
      //   style={[
      //     styles.container,
        ...
        {this.state.show && (
          <View style={[styles.navWrapper, { backgroundColor }]}>
            ...
            <View
              style={[
                styles.nav,
                { height: /*(Platform.OS === 'ios' ? 52 : 62)*/ getHeaderHeight() }
              ]}>
              {!hideBack && (
                <TouchableOpacity
                  accessible={true}
