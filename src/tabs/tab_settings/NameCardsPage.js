...
class NameCardsPage extends React.Component{
    ...
    componentDidMount(){
      let {uid, name_cards} = this.props

      this.props.trackNameCards(uid, name_cards, (data)=>{
        // console.log(data)
...
const mapStateToProps = (state, ownProps) => {
    ...
    //   friend_profiles:makeFriendProfilesState(state, ownProps),
      ...
      name_cards: makeNameCardsState(state, ownProps),
      is_connected: makeIsConnectedState(state, ownProps),
    }
}
  
export default connect(mapStateToProps, actions)(NameCardsPage);